...
<head>
    ...
    {{--<link href="{{ asset('css/jquery.mCustomScrollbar.css?v='.time()) }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('css/slick.css?v='.time()) }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('css/slick-theme.css?v='.time()) }}" rel="stylesheet" type="text/css" />--}}



    {{--<link rel="stylesheet" media="all" type="text/css" href="{{ url('/') }}admin/assets/css/sweetalert.css" />
    <link rel="stylesheet" type="text/css" href="{{ url('/') }}admin/assets/css/tokenize2.css" />

    <link rel="stylesheet" href="{{ url('/') }}smart_app_banner/smart-app-banner.css" type="text/css" media="screen">--}}
    ...
    {{--<style>
        ...
        .select-dropdown.property-type.checkbox {
            width: 40%;
        }
        ...
        .property-type.checkbox li:first-child {
            border: medium none;
        }
        ...
        .property-type.checkbox input[type="radio"]:checked + label, .main-search .property-type.checkbox label:hover{
            background-color:#ff6e00; /*fcfd37*/
        }
        .token-search{
            height: 100%;
                    ...
                    <div class="tab-pane fade" style="text-align:center;width:220%;">
                        ...
                        <div  id="sliding2" style="float:left;width:50%;">
                            <div style="margin-right:10%;">
                                ...
                                <!--<button type="submit" class="btn btn-danger btn-block">Skip</button>-->
